                            ...
                            <div class="form-group pd-10 mb-0">
                                <nav class="nav">
                                    <a class="nav-link" data-bs-toggle="tooltip" href="javascript:void(0);"
                                       title="Add attachment"><i class="fas fa-paperclip"></i></a> <a class="nav-link"
                                                                                                      data-bs-toggle="tooltip"
                                                                                                      href="javascript:void(0);"
                                                                                                      title="Add photo"><i
                                                class="far fa-image"></i></a> <a class="nav-link"
                                                                                 data-bs-toggle="tooltip"
                                                                                 href="javascript:void(0);"
                                                                                 title="Add link"><i
                                                class="fas fa-link"></i></a> <a class="nav-link"
                                                                                data-bs-toggle="tooltip"
                                                                                href="javascript:void(0);"
                                                                                title="Emoticons"><i
                                                class="far fa-smile"></i></a> <a class="nav-link"
                                                                                 data-bs-toggle="tooltip"
                                                                                 href="javascript:void(0);"
                                                                                 title="Discard"><i
