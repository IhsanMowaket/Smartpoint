                    ...
                    <div class="card item-card ">
                        <div class="card-body pb-0">
                            <div class="text-center zoom">
                                <a href="{{url('products')}}"><img class="w-100 rounded-5"
                                                                   src="{{asset('build/assets/img/ecommerce/01.jpg')}}"
                                                                   alt="img"></a>
                            </div>
                            <div class="card-body px-0 pb-3">
                                <div class="row">
                                    ...
                                    <div>
                                        <p class="shop-description fs-13 text-muted mt-2 mb-0">Lorem ipsum dolor sit
                                            amet consectetur, adipisicing elit. Dolor ipsum quia saepe esse.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card-footer text-center">
                            <div class="text-center px-2">
                                <a href="{{url('product-cart')}}" class="btn btn-md btn-primary mb-2 ms-2 w-45"><i
                ...
                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-6 alert wishlist-card">
                    <div class="card item-card">
                        <div class="card-body pb-0">
                            <div class="text-center zoom">
                                <a href="{{url('products')}}"><img class="w-100 rounded-5"
                                                                   src="{{asset('build/assets/img/ecommerce/02.jpg')}}"
                                                                   alt="img"></a>
                            </div>
                            <div class="card-body px-0 pb-3">
                                <div class="row">
                ...
                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-6 alert wishlist-card">
                    <div class="card item-card">
                        <div class="card-body pb-0">
                            <div class="text-center zoom">
                                <a href="{{url('products')}}"><img class="w-100 rounded-5"
                                                                   src="{{asset('build/assets/img/ecommerce/03.jpg')}}"
                                                                   alt="img"></a>
                            </div>
                            <div class="card-body px-0 pb-3">
                                <div class="row">
                                    ...
                                    <div>
                                        <p class="shop-description fs-13 mt-2 text-muted mb-0">Lorem ipsum dolor sit
                                            amet consectetur, adipisicing elit. Dolor ipsum quia saepe esse.</p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-6 alert wishlist-card">
                    <div class="card item-card">
                        <div class="card-body pb-0">
                            <div class="text-center zoom">
                                <a href="{{url('products')}}"><img class="w-100 rounded-5"
                                                                   src="{{asset('build/assets/img/ecommerce/04.jpg')}}"
                                                                   alt="img"></a>
                            </div>
                            <div class="card-body px-0 pb-3">
                                <div class="row">
                ...
                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-6 alert wishlist-card">
                    <div class="card item-card">
                        <div class="card-body pb-0">
                            <div class="text-center zoom">
                                <a href="{{url('products')}}"><img class="w-100 rounded-5"
                                                                   src="{{asset('build/assets/img/ecommerce/05.jpg')}}"
                                                                   alt="img"></a>
                            </div>
                            <div class="card-body px-0 pb-3">
                                <div class="row">
                ...
                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-6 alert wishlist-card">
                    <div class="card item-card">
                        <div class="card-body pb-0">
                            <div class="text-center zoom">
                                <a href="{{url('products')}}"><img class="w-100 rounded-5"
                                                                   src="{{asset('build/assets/img/ecommerce/06.jpg')}}"
                                                                   alt="img"></a>
                            </div>
                            <div class="card-body px-0 pb-3">
                                <div class="row">
                ...
                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-6 alert wishlist-card">
                    <div class="card item-card">
                        <div class="card-body pb-0">
                            <div class="text-center zoom">
                                <a href="{{url('products')}}"><img class="w-100 rounded-5"
                                                                   src="{{asset('build/assets/img/ecommerce/09.jpg')}}"
                                                                   alt="img"></a>
                            </div>
                            <div class="card-body px-0 pb-3">
                                <div class="row">
                ...
                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-6 alert wishlist-card">
                    <div class="card item-card">
                        <div class="card-body pb-0">
                            <div class="text-center zoom">
                                <a href="{{url('products')}}"><img class="w-100 rounded-5"
                                                                   src="{{asset('build/assets/img/ecommerce/08.jpg')}}"
                                                                   alt="img"></a>
                            </div>
                            <div class="card-body px-0 pb-3">
                                <div class="row">
                ...
                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-6 alert wishlist-card">
                    <div class="card item-card">
                        <div class="card-body pb-0">
                            <div class="text-center zoom">
                                <a href="{{url('products')}}"><img class="w-100 rounded-5"
                                                                   src="{{asset('build/assets/img/ecommerce/07.jpg')}}"
                                                                   alt="img"></a>
                            </div>
                            <div class="card-body px-0 pb-3">
                                <div class="row">
                ...
                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-6 alert wishlist-card">
                    <div class="card item-card">
                        <div class="card-body pb-0">
                            <div class="text-center zoom">
                                <a href="{{url('products')}}"><img class="w-100 rounded-5"
                                                                   src="{{asset('build/assets/img/ecommerce/11.jpg')}}"
                                                                   alt="img"></a>
                            </div>
                            <div class="card-body px-0 pb-3">
                                <div class="row">
                ...
                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-6 alert wishlist-card">
                    <div class="card item-card">
                        <div class="card-body pb-0">
                            <div class="text-center zoom">
                                <a href="{{url('products')}}"><img class="w-100 rounded-5"
                                                                   src="{{asset('build/assets/img/ecommerce/12.jpg')}}"
                                                                   alt="img"></a>
                            </div>
                            <div class="card-body px-0 pb-3">
                                <div class="row">
                                    ...
                                    <div>
                                        <p class="shop-description mt-2 fs-13 text-muted mb-0">Lorem ipsum dolor sit
                                            amet consectetur, adipisicing elit. Dolor ipsum quia saepe esse.</p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-6 alert wishlist-card">
                    <div class="card item-card">
                        <div class="card-body pb-0">
                            <div class="text-center zoom">
                                <a href="{{url('products')}}"><img class="w-100 rounded-5"
                                                                   src="{{asset('build/assets/img/ecommerce/10.jpg')}}"
                                                                   alt="img"></a>
                            </div>
                            <div class="card-body px-0 pb-3">
                                <div class="row">
