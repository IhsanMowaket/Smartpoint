        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-xl-12">
                            <p>Form control small Size add class <code class="highlighter-rouge">.form-control-sm</code>
                            ...
                            <div class="form-group ">
                                ...
                                <div class="custom-controls-stacked">
                                    <label class="custom-control form-radio custom-control-md">
                                        <input type="radio" class="custom-control-input" name="example-radios01"
                                               value="option1" checked="">
                                        <span class="custom-control-label custom-control-label-md  tx-17">Option 1</span>
                                    </label>
                                    <label class="custom-control form-radio custom-control-md">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row p-0 m-0 mg-b-25 mg-xl-b-0">
                        ...
                        <div class="col-xl-2">
                            <div class="form-group select2-sm">
                                <select class="form-select form-select-sm select2 select2-sm select2-no-search"
                    ...
                    <div class="row p-0 m-0  mg-b-25 mg-xl-b-0">
                        ...
                        <div class="col-xl-2">
                            <div class="form-group">
                                <select class="form-select form-select select2 select2-no-search"
                    ...
                    <div class="row p-0 m-0">
                        ...
                        <div class="col-xl-2">
                            <div class="form-group select2-lg">
                                <select class="form-select form-select-lg select2 select2-no-search"
