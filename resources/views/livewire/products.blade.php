                        ...
                        <div class="card-body h-100">
                            <div class="pro-img-box">
                                <div class="d-flex product-sale">
                                    ...
                                    <a href="{{url('wish-list')}}"><i
                                                class="mdi mdi-heart-outline ms-auto wishlist"></i></a>
                                </div>
                                <a href="{{url('product-details')}}"><img class="w-100"
                                                                          src="{{asset('build/assets/img/ecommerce/01.jpg')}}"
                                                                          alt="product-image">
                                </a>
                                <a href="{{url('product-cart')}}" class="adtocart"> <i
                    ...
                    <div class="card">
                        <div class="card-body h-100">
                            <div class="pro-img-box">
                                <div class="d-flex product-sale">
                                    <a href="{{url('wish-list')}}"><i
                                                class="mdi mdi-heart text-danger ms-auto wishlist"></i></a>
                                </div>
                                <a href="{{url('product-details')}}"><img class="w-100"
                    ...
                    <div class="card">
                        <div class="card-body h-100">
                            <div class="pro-img-box">
                                <div class="d-flex product-sale">
                                    <a href="{{url('wish-list')}}"><i
                                                class="mdi mdi-heart ms-auto wishlist text-danger"></i></a>
                                </div>
                                <a href="{{url('product-details')}}"><img class="w-100"
