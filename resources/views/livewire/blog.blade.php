...
@section('content')
    ...
    <div class="row">
        <div class="col-xxl-6 col-xl-12 col-lg-12 col-md-12">
            <div class="card custom-card">
                ...
                <div class="card-body">
                    <a href="javascript:void(0);" class="mt-4"><h4 class="font-weight-semibold text-dark">Best Place To
                            visit For a Holiday idea of denouncing pleasure?</h4></a>
                    <p class="mb-0 mt-3">I must explain to you how all this mistaken idea of denouncing pleasure and
                ...
                <div class="card-footer p-3">
                    <div class="item7-card-desc d-sm-flex mt-0">
                        <a href="javascript:void(0);" class="d-flex"><span
                            ...
                            <div class="mt-0 mt-0  font-weight-semibold text-muted">Anna Ogden</div>
                        </a>
                        <div class="d-flex ms-auto">
                            <a href="javascript:void(0);" class="d-flex me-3"><span
                                        class="fe fe-calendar text-muted me-2 tx-17"></span>
                                <div class="mt-0 mt-0  font-weight-semibold text-muted">Jan-18-2020</div>
                            </a>
                            <a class="me-0 d-flex" href="javascript:void(0);"><span
                                        class="fe fe-message-square text-muted me-2 tx-17"></span>
                                <div class="mt-0 mt-0  font-weight-semibold text-muted">12 Comments</div>
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-xxl-3 col-xl-6 col-lg-6  col-sm-6">
            <div class="card custom-card card-img-top-1">
                ...
                <div class="card-body pb-0">
                    <a href="{{url('blog-details')}}"><h4 class="card-title">10 Ways To Immediately Start Selling
                            Products !</h4></a>
                    <p class="mb-2">Those who do not know how pursues or desires to occur in which toil and pain can
                        procure him some great pleasure. To take a trivial example pain was born and I will give you a
                        complete account of the system, and expound the actual teachings of the great explorer of the
                        truth, the master-buil .the great explorer of the truth, the master-buil</p>
                </div>
                <div class="item7-card-desc d-flex p-3 pt-0 align-items-center justify-content-center border-top">
                    ...
                    <div class="ms-auto">
                        <a class="me-0 d-flex" href="javascript:void(0);"><span
                                    class="phone font-weight-semibold text-muted"><span
                                        class="fe fe-calendar text-muted me-2 tx-16"></span>Aug 01,2021</span></a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="item-list">
                            <ul class="list-group mb-0">
                                <li class="list-group-item d-flex  border-bottom-0">
                                    <img src="{{asset('build/assets/img/photos/26.jpg')}}"
                                ...
                                <li class="list-group-item d-flex border-bottom-0">
                                    <img src="{{asset('build/assets/img/photos/24.jpg')}}"
                                         class="avatar rounded-5 avatar-lg me-3 my-auto" alt="avatar-img">
                                    <div class="my-auto">
    ...
    <div class="row ">
        <div class="col-xxl-3 col-xl-6 col-lg-6  col-sm-6">
            <div class="card custom-card card-img-top-1">
                <a href="{{url('blog-details')}}"><img class="card-img-top w-100 w-100"
                                                       src="{{asset('build/assets/img/photos/2.jpg')}}" alt=""></a>
                <div class="card-body pb-0">
                    <a href="{{url('blog-details')}}"><h4 class="card-title">How To Become Better With Building In 1
                            Month !</h4></a>
                    <p class="card-text mb-2">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia
                ...
                <div class="item7-card-desc d-flex p-3 pt-0 align-items-center justify-content-center border-top">
                    ...
                    <div class="ms-auto">
                        <a class="me-0 d-flex" href="javascript:void(0);"><span
                                    class="phone font-weight-semibold text-muted"><span
                                        class="fe fe-calendar text-muted me-2 tx-16"></span>Aug 24,2021</span></a>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-xxl-3 col-xl-6 col-lg-6  col-sm-6">
            <div class="card custom-card card-img-top-1">
                <a href="{{url('blog-details')}}"><img class="card-img-top w-100 w-100"
                                                       src="{{asset('build/assets/img/photos/1.jpg')}}" alt=""></a>
                <div class="card-body pb-0">
                    <a href="{{url('blog-details')}}"><h4 class="card-title">10 Ways To Immediately Start Selling
                            Products !</h4></a>
                    <p class="card-text mb-2">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia
        ...
        <div class="col-xxl-3 col-xl-6 col-lg-6  col-sm-6">
            <div class="card custom-card card-img-top-1">
                <a href="{{url('blog-details')}}"><img class="card-img-top w-100 w-100"
                                                       src="{{asset('build/assets/img/photos/9.jpg')}}" alt=""></a>
                <div class="card-body pb-0">
                    <a href="{{url('blog-details')}}"><h4 class="card-title">3 Easy Ways To Make Your mobile Faster &
                            Even !</h4></a>
                    <p class="card-text mb-2">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia
                        deserunt mollit anim id est laborum.</p>
                </div>
                <div class="item7-card-desc d-flex p-3 pt-0 align-items-center justify-content-center border-top">
                    ...
                    <div class="ms-auto">
                        <a class="me-0 d-flex" href="javascript:void(0);"><span
                                    class="phone font-weight-semibold text-muted"><span
                                        class="fe fe-calendar text-muted me-2 tx-16"></span>Feb 19,2021</span></a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="list-group list-lg-group list-group-flush">
                        ...
                        <a href="javascript:void(0);" class="border-0">
                            <div class="list-group-item list-group-item-action">
                                <div class="media mt-0">
                                    <img class="avatar-lg rounded-circle me-3 my-auto"
                                         src="{{asset('build/assets/img/users/17.jpg')}}" alt="Image description">
                                    <div class="media-body">
                                        <div class="d-flex align-items-center">
                                            <div class="mt-1">
                        ...
                        <a href="javascript:void(0);" class="border-0">
                            <div class="list-group-item list-group-item-action">
                                <div class="media mt-0">
                                    <img class="avatar-lg rounded-circle me-3 my-auto"
                                         src="{{asset('build/assets/img/users/15.jpg')}}" alt="Image description">
                                    <div class="media-body">
                                        <div class="d-flex align-items-center">
                                            <div class="mt-1">
