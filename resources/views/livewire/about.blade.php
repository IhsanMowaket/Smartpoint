    ...
    <div class="container">
        <div class="row about-main mb-5">
            <div class="col-lg-8 col-md-8 col-sm-12 text-center">
                <h1 class="mb-3 font-weight-semibold tx-46">Hello! This is <span
                            class="text-primary tx-56">Valex.</span></h1>
                <p class="leading-normal lead-1">Majority have suffered alteration in some form.</p>
                <p class="leading-normal  tx-16">There are many variations of passages of Lorem Ipsum available, but the
                    ...
                    <div class="card-body p-0 p-lg-5 text-dark">
                        <div class="statistics-info p-4">
                            <div class="row">
                                <div class="col-xl-6">
                                    <div class="">
                                        <h2 class="fw-bold mb-4 text-dark">We Help to <span
                                                    class="text-primary">Build</span> Your Dream Project.</h2>
                                        <h5 class="leading-normal fw-normal mb-4 text-dark">majority have suffered
                                            alteration in some form, by injected humour</h5>
                                        <p>There are many variations of passages of Lorem Ipsum available, but the
                                            majority have suffered by injected humour, or randomised words which don't
                                            look even slightly believable.</p>
                                        <p>All the Lorem Ipsum generators on the Internet tend to repeat Various
                                            versions have evolved over the years, sometimes by accident, sometimes on
                                            purpose (injected humour and the like).</p>
                                        <p> If you are going to use a passage of Lorem Ipsum, you need to as necessary
            ...
            <div class="col-xl-3 col-lg-6 col-md-6">
                <div class="card bg-danger-transparent">
                    <div class="card-body">
                        <div class="counter-status md-mb-0">
                            <div class="text-center mb-1">
                                <svg class="about-icons" xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                <div class="card p-3">
                    <div class="card-body">
                        ...
                        <div class="text-center tx-14 mb-3">Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                            Quibusdam similique provident !
                        </div>
                        <p class="text-center mb-0"><i class="fe fe-facebook text-primary me-3"></i><i
                                    class="fe fe-instagram text-success me-3"></i><i class="fe fe-globe text-info"></i>
                        </p>
                    </div>
                </div>
            </div>
