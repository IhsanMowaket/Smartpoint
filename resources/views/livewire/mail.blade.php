                    ...
                    <div class="main-content-left main-content-left-mail">
                        ...
                        <div class="main-mail-menu">
                            <nav class="nav main-nav-column mg-b-20">
                                <a class="nav-link active" href="javascript:void(0);"><i class="bx bxs-inbox"></i> Inbox
                                    <span>20</span></a> <a class="nav-link" href="javascript:void(0);"><i
                                            class="bx bx-star"></i> Starred <span>3</span></a> <a class="nav-link"
                                                                                                  href="javascript:void(0);"><i
                                            class="bx bx-bookmarks"></i> Important <span>10</span></a> <a
                                        class="nav-link" href="javascript:void(0);"><i class="bx bx-send"></i> Sent Mail
                                    <span>8</span></a> <a class="nav-link" href="javascript:void(0);"><i
                                            class="bx bx-edit"></i> Drafts <span>15</span></a> <a class="nav-link"
                                                                                                  href="javascript:void(0);"><i
                                            class="bx bx-message-error"></i> Spam <span>128</span></a> <a
                                        class="nav-link" href="javascript:void(0);"><i class="bx bx-trash"></i> Trash
                                    <span>6</span></a>
                            </nav>
                            <label class="main-content-label main-content-label-sm">Label</label>
                            <nav class="nav main-nav-column mg-b-20">
                                <a class="nav-link" href="javascript:void(0);"><i class="bx bx-folder-open"></i> Social
                                    <span>10</span></a> <a class="nav-link" href="javascript:void(0);"><i
                                            class="bx bx-folder"></i> Promotions <span>22</span></a> <a class="nav-link"
                                                                                                        href="javascript:void(0);"><i
                                            class="bx bx-folder-plus"></i> Updates <span>17</span></a>
                            </nav>
                            <label class="main-content-label main-content-label-sm">Tags</label>
                            <nav class="nav main-nav-column">
                                <a class="nav-link" href="javascript:void(0);"><i class="bx bxl-twitter"></i> Twitter
                                    <span>2</span></a> <a class="nav-link" href="javascript:void(0);"><i
                                            class="bx bxl-github"></i> Github <span>32</span></a> <a class="nav-link"
                                                                                                     href="javascript:void(0);"><i
                                            class="bx bxl-google-plus"></i> Google <span>7</span></a>
                            </nav>
                        </div><!-- main-mail-menu -->
                    </div>
                </div>
                ...
                <div class="main-content-body main-content-body-mail card-body">
                    ...
                    <div class="main-mail-list">
                        <div class="main-mail-item unread">
                            ...
                            <div class="main-img-user"><img alt="" src="{{asset('build/assets/img/users/5.jpg')}}">
                            </div>
                        ...
                        <div class="main-mail-item unread">
                            ...
                            <div class="main-img-user"><img alt="" src="{{asset('build/assets/img/users/2.jpg')}}">
                            </div>
                            <div class="main-mail-body">
                                <div class="main-mail-from">
                                    Albert Ansing
                        ...
                        <div class="main-mail-item">
                            ...
                            <div class="main-img-user"><img alt="" src="{{asset('build/assets/img/users/9.jpg')}}">
                            </div>
                            <div class="main-mail-body">
                                <div class="main-mail-from">
                                    Carla Guden
                        ...
                        <div class="main-mail-item unread">
                            ...
                            <div class="main-img-user"><img alt="" src="{{asset('build/assets/img/users/10.jpg')}}">
                            </div>
                            <div class="main-mail-body">
                                <div class="main-mail-from">
                                    Reven Galeon
                        ...
                        <div class="main-mail-item">
                            ...
                            <div class="main-img-user"><img alt="" src="{{asset('build/assets/img/users/12.jpg')}}">
                            </div>
                            <div class="main-mail-body">
                                <div class="main-mail-from">
                                    Elisse Tan
                        ...
                        <div class="main-mail-item">
                            ...
                            <div class="main-img-user"><img alt="" src="{{asset('build/assets/img/users/14.jpg')}}">
                            </div>
                            <div class="main-mail-body">
                                <div class="main-mail-from">
                                    Marianne Audrey
                        ...
                        <div class="main-mail-item">
                            ...
                            <div class="main-img-user"><img alt="" src="{{asset('build/assets/img/users/15.jpg')}}">
                            </div>
                            <div class="main-mail-body">
                                <div class="main-mail-from">
                                    Raffy Godinez
                        ...
                        <div class="main-mail-item">
                            ...
                            <div class="main-img-user"><img alt="" src="{{asset('build/assets/img/users/7.jpg')}}">
                            </div>
                            <div class="main-mail-body">
                                <div class="main-mail-from">
                                    Allan Cadungog
                        ...
                        <div class="main-mail-item border-bottom-0">
                            ...
                            <div class="main-img-user"><img alt="" src="{{asset('build/assets/img/users/1.jpg')}}">
                            </div>
                            <div class="main-mail-body">
                                <div class="main-mail-from">
                                    Jove Guden
