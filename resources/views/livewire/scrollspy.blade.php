                ...
                <div class="card-body pt-0">
                    ...
                    <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-offset="0"
                        ...
                        <div id="scrollspyHeading1">
                            ...
                            <p class="fs-14">It is a long established fact that a reader will be distracted by the
                    ...
                    <div class="row g-0">
                        <div class="col-lg-4 col-md-12 p-0">
                            <nav id="navbar-example3"
                                 class="navbar navbar-light bg-light flex-column align-items-stretch p-3 br-ts-5 br-bs-5">
                                <a class="navbar-brand" href="javascript:void(0);">Navbar</a>
                        ...
                        <div class="col-lg-8 col-md-12 p-0">
                            <div data-bs-spy="scroll" data-bs-target="#navbar-example3" class="scrollspy-example-2"
                                 data-bs-offset="0" tabindex="0">
                                <div id="item-1">
                                    <h4 class="fs-16 fw-semibold">Item 1</h4>
                                    <p class="fs-14">It is a long established fact that a reader will be distracted by
