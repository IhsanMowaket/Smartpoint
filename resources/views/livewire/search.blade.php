        ...
        <div class="col-sm-12 col-md-12">
            ...
            <div class="card custom-card">
                <div class="card-body">
                    ...
                    <h6 class="tx-13">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum
                        dolore eu fugiat nulla pariatur eu fugiat nulla pariatur</h6>
                    <p class="mb-0 text-muted"> it is pleasure, but because those who do not know how to pursue pleasure
                        rationally
                        encounter consequences that are extremely painful. Nor again is there anyone who loves or
                        pursues or desires to
                        obtain pain of itself, because it is pain, but because occasionally circumstances occur in which
                        ...
                        pleasure that has no annoying consequences</p>
                </div>
            </div>
            <div class="card custom-card">
                <div class="card-body">
