                ...
                <div class="card-body">
                    ...
                    <div class="tx-center pd-y-20 background">
                        <a class="btn btn-main-primary" data-bs-target="#modaldemo1" data-bs-toggle="modal"
                           href="javascript:void(0);">View Live Demo</a>
                    </div><!-- pd-y-30 -->
                    <div class="modal">
                                ...
                                <div class="modal-body pd-sm-40">
                                    ...
                                    <div class="form-group mg-b-25">
                                        <label class="ckbox mg-b-5"><input type="checkbox"><span class="tx-13">I agree to <a
                                                        ...
                                                        href="javascript:void(0);">Privacy Policy</a></span></label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="pos-relative">
                                        ...
                                        <div class="d-flex pos-absolute t-5 r-10"><img alt="" class="wd-30 mg-r-5"
                                                                                       src="{{asset('build/assets/img/pngs/13.png')}}">
                                            <img alt="" class="wd-30" src="{{asset('build/assets/img/pngs/12.png')}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
        ...
        <div class="modal-dialog wd-xl-400" role="document">
            <div class="modal-content">
                <div class="modal-body pd-20 pd-sm-40">
                    <button type="button" class="close pos-absolute t-15 r-20 tx-26" data-bs-dismiss="modal"
                            aria-label="Close">
                    ...
                    <div class="form-group mg-b-25">
                        <label class="ckbox mg-b-5">
                            <input type="checkbox">
                            <span class="tx-13">I agree to <a href="javascript:void(0);">Terms</a> and <a
