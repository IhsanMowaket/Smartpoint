            ...
            <div class="col-xl-4 col-sm-12 col-md-6  col-lg-4">
                ...
                <div class="card custom-card  bg-primary tx-white card-draggable">
                    <div class="card-body custom-hvr">
                        ...
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of
                            the card's content.</p><a class="card-link tx-white-7 hover-white"
                                                      href="javascript:void(0);">Card link</a> <a
                                class="card-link tx-white-7 hover-white" href="javascript:void(0);">Another link</a>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="card custom-card card-draggable">
                    <div class="card-body">
                        ...
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of
                            the card's content.</p><a class="card-link" href="javascript:void(0);">Card link</a> <a
            ...
            <div class="col-xl-4 col-sm-12 col-md-12 col-lg-4">
                ...
                <div class="card custom-card card-draggable">
                    <img alt="Image" class="card-img img-fluid card-img-top"
                         src="{{asset('build/assets/img/photos/6.jpg')}}">
