                ...
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        <div class="example">
                            <div class="btn-group ms-2 mt-2 mb-2">
                                <div class="dropdown">
                                    <button aria-expanded="false" aria-haspopup="true" class="btn ripple btn-primary"
                                            data-bs-toggle="dropdown" id="dropdownMenuButton" type="button">Dropdown
                                        Menu <i class="fas fa-caret-down ms-1"></i></button>
                            ...
                            <div class="btn-group ms-2 mt-2 mb-2">
                                <div class="dropdown">
                                    <button aria-expanded="false" aria-haspopup="true" class="btn ripple btn-secondary"
                                            data-bs-toggle="dropdown" id="dropdownMenuButton1" type="button">Dropdown
                                        Menu <i class="fas fa-caret-down ms-1"></i></button>
                                    <div class="dropdown-menu tx-13">
                                        <a class="dropdown-item" href="javascript:void(0);">Action</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Another action</a>
                            ...
                            <div class="btn-group ms-2 mt-2 mb-2">
                                <div class="dropdown">
                                    <button aria-expanded="false" aria-haspopup="true" class="btn ripple btn-teal"
                                            data-bs-toggle="dropdown" id="dropdownMenuButton2" type="button">Dropdown
                                        Menu <i class="fas fa-caret-down ms-1"></i></button>
                                    <div class="dropdown-menu tx-13">
                                        <a class="dropdown-item" href="javascript:void(0);">Action</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Another action</a>
                            ...
                            <div class="btn-group ms-2 mt-2 mb-2">
                                <div class="dropdown">
                                    <button aria-expanded="false" aria-haspopup="true" class="btn ripple btn-light"
                                            data-bs-toggle="dropdown" id="dropdownMenuButton3" type="button">Dropdown
                                        Menu <i class="fas fa-caret-down ms-1"></i></button>
                                    <div class="dropdown-menu tx-13">
                                        <a class="dropdown-item" href="javascript:void(0);">Action</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Another action</a>
                    ...
                    <div class="text-wrap">
                        <div class="example">
                            <div class="btn-group ms-2 mt-2 mb-2">
                                <div class="dropdown">
                                    <button aria-expanded="false" aria-haspopup="true"
                                            class="btn ripple btn-rounded btn-primary" data-bs-toggle="dropdown"
                                            id="dropdownMenuButton4" type="button">Dropdown Menu <i
                            ...
                            <div class="btn-group ms-2 mt-2 mb-2">
                                <div class="dropdown">
                                    <button aria-expanded="false" aria-haspopup="true"
                                            class="btn ripple btn-rounded btn-secondary" data-bs-toggle="dropdown"
                                            id="dropdownMenuButton5" type="button">Dropdown Menu <i
                                                class="fas fa-caret-down ms-1"></i></button>
                                    <div class="dropdown-menu tx-13">
                                        <a class="dropdown-item" href="javascript:void(0);">Action</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Another action</a>
                            ...
                            <div class="btn-group ms-2 mt-2 mb-2">
                                <div class="dropdown">
                                    <button aria-expanded="false" aria-haspopup="true"
                                            class="btn ripple  btn-rounded btn-teal" data-bs-toggle="dropdown"
                                            id="dropdownMenuButton6" type="button">Dropdown Menu <i
                                                class="fas fa-caret-down ms-1"></i></button>
                                    <div class="dropdown-menu tx-13">
                                        <a class="dropdown-item" href="javascript:void(0);">Action</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Another action</a>
                            ...
                            <div class="btn-group ms-2 mt-2 mb-2">
                                <div class="dropdown">
                                    <button aria-expanded="false" aria-haspopup="true"
                                            class="btn ripple  btn-rounded btn-light" data-bs-toggle="dropdown"
                                            id="dropdownMenuButton7" type="button">Dropdown Menu <i
                                                class="fas fa-caret-down ms-1"></i></button>
                                    <div class="dropdown-menu tx-13">
                                        <a class="dropdown-item" href="javascript:void(0);">Action</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Another action</a>
                    ...
                    <div class="text-wrap">
                        <div class="example">
                            <div class="btn-group ms-2 mt-2 mb-2">
                                <div class="dropdown">
                                    <button aria-expanded="false" aria-haspopup="true"
                                            class="btn ripple btn-outline-primary" data-bs-toggle="dropdown"
                                            id="dropdownMenuButton8" type="button">Dropdown Menu <i
                                                class="fas fa-caret-down ms-1"></i></button>
                                    <div class="dropdown-menu tx-13">
                                        <a class="dropdown-item" href="javascript:void(0);">Action</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Another action</a>
                            ...
                            <div class="btn-group ms-2 mt-2 mb-2">
                                <div class="dropdown">
                                    <button aria-expanded="false" aria-haspopup="true"
                                            class="btn ripple btn-outline-secondary" data-bs-toggle="dropdown"
                                            id="dropdownMenuButton9" type="button">Dropdown Menu <i
                                                class="fas fa-caret-down ms-1"></i></button>
                                    <div class="dropdown-menu tx-13">
                                        <a class="dropdown-item" href="javascript:void(0);">Action</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Another action</a>
                            ...
                            <div class="btn-group ms-2 mt-2 mb-2">
                                <div class="dropdown">
                                    <button aria-expanded="false" aria-haspopup="true"
                                            class="btn ripple btn-outline-success" data-bs-toggle="dropdown"
                                            id="dropdownMenuButton10" type="button">Dropdown Menu <i
                                                class="fas fa-caret-down ms-1"></i></button>
                                    <div class="dropdown-menu tx-13">
                                        <a class="dropdown-item" href="javascript:void(0);">Action</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Another action</a>
                            ...
                            <div class="btn-group ms-2 mt-2 mb-2">
                                <div class="dropdown">
                                    <button aria-expanded="false" aria-haspopup="true"
                                            class="btn ripple btn-outline-light" data-bs-toggle="dropdown"
                                            id="dropdownMenuButton11" type="button">Dropdown Menu <i
                                                class="fas fa-caret-down ms-1"></i></button>
                                    <div class="dropdown-menu tx-13">
                                        <a class="dropdown-item" href="javascript:void(0);">Action</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Another action</a>
                    ...
                    <div class="text-wrap">
                        <div class="example">
                            <div class="btn-group ms-2 mt-2 mb-2">
                                <div class="dropdown">
                                    <button aria-expanded="false" aria-haspopup="true"
                                            class="btn ripple btn-rounded btn-outline-primary" data-bs-toggle="dropdown"
                                            id="dropdownMenuButton12" type="button">Dropdown Menu <i
                                                class="fas fa-caret-down ms-1"></i></button>
                                    <div class="dropdown-menu tx-13">
                                        <a class="dropdown-item" href="javascript:void(0);">Action</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Another action</a>
                            ...
                            <div class="btn-group ms-2 mt-2 mb-2">
                                <div class="dropdown">
                                    <button aria-expanded="false" aria-haspopup="true"
                                            class="btn ripple btn-rounded btn-outline-secondary"
                                            data-bs-toggle="dropdown" id="dropdownMenuButton13" type="button">Dropdown
                                        Menu <i class="fas fa-caret-down ms-1"></i></button>
                                    <div class="dropdown-menu tx-13">
                                        <a class="dropdown-item" href="javascript:void(0);">Action</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Another action</a>
                            ...
                            <div class="btn-group ms-2 mt-2 mb-2">
                                <div class="dropdown">
                                    <button aria-expanded="false" aria-haspopup="true"
                                            class="btn ripple  btn-rounded btn-outline-success"
                                            data-bs-toggle="dropdown" id="dropdownMenuButton14" type="button">Dropdown
                                        Menu <i class="fas fa-caret-down ms-1"></i></button>
                                    <div class="dropdown-menu tx-13">
                                        <a class="dropdown-item" href="javascript:void(0);">Action</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Another action</a>
                            ...
                            <div class="btn-group ms-2 mt-2 mb-2">
                                <div class="dropdown">
                                    <button aria-expanded="false" aria-haspopup="true"
                                            class="btn ripple  btn-rounded btn-outline-light" data-bs-toggle="dropdown"
                                            id="dropdownMenuButton15" type="button">Dropdown Menu <i
                                                class="fas fa-caret-down ms-1"></i></button>
                                    <div class="dropdown-menu tx-13">
                                        <a class="dropdown-item" href="javascript:void(0);">Action</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Another action</a>
                        ...
                        <div class="example">
                            ...
                            <div class="btn-group ms-2 mt-2 mb-2">
                                <div class="dropdown btn-group">
                                    ...
                                    <button type="button" class="btn btn-info dropdown-toggle split-dropdown"
                                            data-bs-toggle="dropdown">
                                        <span class="caret"></span>
                                        <span class="sr-only">Toggle Dropdown</span>
                                    </button>
                ...
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        <div class="example">
                            <div class="btn-group ms-2 mt-2 mb-2">
                                <div class="dropdown">
                                    <button aria-expanded="false" aria-haspopup="true" class="btn ripple btn-warning"
                                            data-bs-toggle="dropdown" type="button">Dropdown Menu<i
                                                class="fas fa-caret-down ms-1"></i></button>
                                    <div class="dropdown-menu tx-13">
                                        <a class="dropdown-item" href="javascript:void(0);">Action</a>
                            ...
                            <div class="btn-group ms-2 mt-2 mb-2">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu tx-13">
                                        <a class="dropdown-item" href="javascript:void(0);">Action</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Another action</a>
                                        <a class="dropdown-item  active" href="javascript:void(0);">Something else
                                            here</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="btn-group ms-2 mt-2 mb-2">
                                <div class="dropdown">
                                    <button aria-expanded="false" aria-haspopup="true" class="btn ripple btn-danger"
                                            data-bs-toggle="dropdown" type="button">Dropdown Menu<i
                                                class="fas fa-caret-down ms-1"></i></button>
                                    <div class="dropdown-menu tx-13">
                                        <a class="dropdown-item" href="javascript:void(0);">Action</a>
                            ...
                            <div class="row row-xs">
                                <div class="col-sm-6 col-md-6">
                                    <div class="dropdown dropend">
                                        <button aria-expanded="false" aria-haspopup="true"
                                                class="btn ripple btn-info  dropdown-toggle" data-bs-toggle="dropdown"
                                                id="droprightMenuButton" type="button">Dropright Menu
                                        </button>
                                ...
                                <div class="col-sm-6 col-md-6 mg-t-10 mg-sm-t-0">
                                    <div class="dropdown dropstart">
                                        <button aria-expanded="false" aria-haspopup="true"
                                                class="btn ripple btn-danger dropdown-toggle" data-bs-toggle="dropdown"
                                                id="dropleftMenuButton" type="button">Dropleft Menu
                                        </button>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu tx-13">
                                        ...
                                        <a class="dropdown-item" href="javascript:void(0);">Action</a> <a
                                                class="dropdown-item" href="javascript:void(0);">Another action</a>
                                        <a class="dropdown-item" href="javascript:void(0);">Something else here</a>
