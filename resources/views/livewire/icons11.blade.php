    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Materialdesign icons</li>
            </ol>
        </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card custom-card">
                <div class="card-header mb-0 mt-2 ms-1 border-bottom-0">
                    <h6 class="main-content-label mb-0">Materialdesign icons</h6>
                    <p class="mb-0 mt-3">Simply beautiful open source icons. For more Icons <a
                                href="https://material.io/resources/icons/?style=baseline" target="_blank"
                                class="btn-link text-primary">click here</a></p>
                </div>
                <div class="card-body">
            ...
            <div class="card custom-card">
                <div class="card-header mb-0 mt-2 ms-1 border-bottom-0">
                    <h6 class="main-content-label mb-0">Material Outlined Icons</h6>
                    <p class="mb-0 mt-3">Simply beautiful open source icons. For more Icons <a
                                href="https://material.io/resources/icons/?style=outline" target="_blank"
                                class="btn-link">click here</a>.</p>
                </div>
                <div class="card-body">
                    <div class="row row-sm">
                        <div class="col-sm-12 col-lg-12">
            ...
            <div class="card custom-card">
                <div class="card-header mb-0 mt-2 ms-1 border-bottom-0">
                    <h6 class="main-content-label mb-0">Material Two Toned Icons</h6>
                    <p class="mb-0 mt-3">Simply beautiful open source icons. For more Icons <a
                                href="https://material.io/resources/icons/?style=twotone" target="_blank"
                                class="btn-link">click here</a>.</p>
                </div>
                <div class="card-body">
                    <div class="row row-sm">
                                ...
                                <ul class="icons-list">
                                    ...
                                    <li class="icons-list-item">
                                        <svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="24"
                                             viewBox="0 0 24 24" width="24">
                                            <path d="M0 0h24v24H0V0z" fill="none"/>
                                            <path d="M4 4v13.17l.59-.59.58-.58H20V4H4zm9 11h-2v-2h2v2zm0-4h-2V5h2v6z"
                                                  opacity=".3"/>
                                    ...
                                    <li class="icons-list-item">
                                        <svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="24"
                                            ...
                                            <path d="M8.13 10H5v2h4.4c-.6-.53-1.06-1.22-1.27-2zm6.47 2H19v-2h-3.13c-.21.78-.67 1.47-1.27 2zm-6.38 5.25c-.03-.08-.06-.16-.09-.25H5v2h4.4c-.53-.47-.94-1.07-1.18-1.75zm7.65-.25c-.02.09-.06.17-.09.25-.23.68-.64 1.28-1.18 1.75H19v-2h-3.13z"
                                                  opacity=".3"/>
                                        </svg>
                                    </li>
                                    <li class="icons-list-item">
                                    ...
                                    <li class="icons-list-item">
                                        <svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="24"
                                             viewBox="0 0 24 24" width="24">
                                            <path d="M0 0h24v24H0V0z" fill="none"/>
                                            <path d="M17.11 10.83l-2.47-.21-1.2-.1-.47-1.11L12 7.13l-.97 2.28-.47 1.11-1.2.1-2.47.21 1.88 1.63.91.79-.27 1.17-.57 2.42 2.13-1.28 1.03-.63 1.03.63 2.13 1.28-.57-2.42-.27-1.17.91-.79z"
                                                  opacity=".3"/>
                                    ...
                                    <li class="icons-list-item">
                                        <svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="24"
                                             viewBox="0 0 24 24" width="24">
                                            <path d="M0 0h24v24H0V0z" fill="none"/>
                                            <path d="M18.49 9.89l.26-2.79-2.74-.62-1.43-2.41L12 5.18 9.42 4.07 7.99 6.48l-2.74.62.26 2.78L3.66 12l1.85 2.11-.26 2.8 2.74.62 1.43 2.41L12 18.82l2.58 1.11 1.43-2.41 2.74-.62-.26-2.79L20.34 12l-1.85-2.11zM13 17h-2v-2h2v2zm0-4h-2V7h2v6z"
                                                  opacity=".3"/>
                                    ...
                                    <li class="icons-list-item">
                                        <svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="24"
                                             viewBox="0 0 24 24" width="24">
                                            <path d="M0 0h24v24H0V0z" fill="none"/>
                                            <path d="M3 19h18V5H3v14zm8-7c.35 0 .69.07 1 .18V6h5v2h-3v7.03c-.02 1.64-1.35 2.97-3 2.97-1.66 0-3-1.34-3-3s1.34-3 3-3z"
                                                  opacity=".3"/>
                                    ...
                                    <li class="icons-list-item">
                                        <svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="24"
                                             viewBox="0 0 24 24" width="24">
                                            <path d="M0 0h24v24H0V0z" fill="none"/>
                                            <path d="M15.2 18.21c1.21.41 2.48.67 3.8.76v-1.5c-.88-.07-1.75-.22-2.6-.45l-1.2 1.19zM6.54 5h-1.5c.09 1.32.35 2.59.75 3.79l1.2-1.21c-.24-.83-.39-1.7-.45-2.58zM14 8h5V5h-5z"
                                                  opacity=".3"/>
                                    ...
                                    <li class="icons-list-item">
                                        <svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="24"
                                             viewBox="0 0 24 24" width="24">
                                            <path d="M0 0h24v24H0V0z" fill="none"/>
                                            <path d="M20 16V6H4v10.01L20 16zm-7-1.53v-2.19c-2.78 0-4.61.85-6 2.72.56-2.67 2.11-5.33 6-5.87V7l4 3.73-4 3.74z"
                                                  opacity=".3"/>
                                    ...
                                    <li class="icons-list-item">
                                        <svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="24"
                                             viewBox="0 0 24 24" width="24">
                                            <path d="M0 0h24v24H0V0z" fill="none"/>
                                            <path d="M19 17.47c-.88-.07-1.75-.22-2.6-.45l-1.19 1.19c1.2.41 2.48.67 3.8.75v-1.49zM5.03 5c.09 1.32.35 2.59.75 3.8l1.2-1.2c-.23-.84-.38-1.71-.44-2.6H5.03z"
                                                  opacity=".3"/>
                                    ...
                                    <li class="icons-list-item">
                                        <svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="24"
                                             viewBox="0 0 24 24" width="24">
                                            <path d="M0 0h24v24H0V0z" fill="none"/>
                                            <path d="M20 6h-4.05l-1.83-2H9.88L8.05 6H4v12h16V6zm-8 11c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5z"
                                                  opacity=".3"/>
                                    ...
                                    <li class="icons-list-item">
                                        <svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="24"
                                             viewBox="0 0 24 24" width="24">
                                            <path d="M0 0h24v24H0V0z" fill="none"/>
                                            <path d="M9.83 18l.59.59L12 20.17l1.59-1.59.58-.58H19V4H5v14h4.83zM12 5c1.65 0 3 1.35 3 3s-1.35 3-3 3-3-1.35-3-3 1.35-3 3-3zM6 15.58C6 13.08 9.97 12 12 12s6 1.08 6 3.58V17H6v-1.42z"
                                                  opacity=".3"/>
                                    ...
                                    <li class="icons-list-item">
                                        <svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="24"
                                             viewBox="0 0 24 24" width="24">
                                            <path d="M0 0h24v24H0V0z" fill="none"/>
                                            <path d="M12 4c-4.42 0-8 3.58-8 8s3.58 8 8 8 8-3.58 8-8-3.58-8-8-8zm4.25 12.15L11 13V7h1.5v5.25l4.5 2.67-.75 1.23z"
                                                  opacity=".3"/>
                                    ...
                                    <li class="icons-list-item">
                                        <svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="24"
                                             viewBox="0 0 24 24" width="24">
                                            <path d="M4.47 19h15.06L12 5.99 4.47 19zM13 18h-2v-2h2v2zm0-4h-2v-4h2v4z"
                                                  opacity=".3"/>
