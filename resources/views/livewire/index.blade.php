            ...
            <div class="card">
                ...
                <div class="product-timeline card-body pt-2 mt-1">
                    <ul class="timeline-1 mb-0">
                        <li class="mt-0 mrg-8"><i class="ti-pie-chart bg-primary-gradient text-white product-icon"></i>
                            <span class="fw-semibold mb-4 tx-14 ">Total Products</span> <a href="javascript:void(0);"
                                                                                           class="float-end tx-11 text-muted">3
                                days ago</a>
                            <p class="mb-0 text-muted tx-12">1.3k New Products</p>
                        </li>
                        <li class="mt-0 mrg-8"><i
                                ...
                                class="fw-semibold mb-4 tx-14 ">Total Sales</span> <a href="javascript:void(0);"
                                                                                      class="float-end tx-11 text-muted">35
                                mins ago</a>
                        ...
                        <li class="mt-0 mrg-8"><i
                                ...
                                class="fw-semibold mb-4 tx-14 ">Toatal Revenue</span> <a href="javascript:void(0);"
                                                                                         class="float-end tx-11 text-muted">50
                                mins ago</a>
                            <p class="mb-0 text-muted tx-12">23.5K New Revenue</p>
                        </li>
                        <li class="mt-0 mrg-8"><i class="ti-wallet bg-warning-gradient text-white product-icon"></i>
                            <span class="fw-semibold mb-4 tx-14 ">Toatal Profit</span> <a href="javascript:void(0);"
                                                                                          class="float-end tx-11 text-muted">1
                                hour ago</a>
                            <p class="mb-0 text-muted tx-12">3k New profit</p>
                        </li>
                        <li class="mt-0 mrg-8"><i class="si si-eye bg-purple-gradient text-white product-icon"></i>
                            <span class="fw-semibold mb-4 tx-14 ">Customer Visits</span> <a href="javascript:void(0);"
                                                                                            class="float-end tx-11 text-muted">1
                                day ago</a>
