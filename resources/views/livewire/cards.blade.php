        ...
        <div class="col-md">
            <div class="card bg-gray-200 bd-0">
                <div class="card-body">
                    ...
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the
                        card's content.</p><a class="card-link" href="javascript:void(0);">Card link</a> <a
                            class="card-link" href="javascript:void(0);">Another link</a>
                </div>
            </div>
        </div>
        <div class="col-md mg-md-t-0">
            <div class="card bg-secondary tx-white bd-0">
                <div class="card-body">
                    ...
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the
                        card's content.</p><a class="card-link tx-white-7 hover-white" href="javascript:void(0);">Card
                        link</a> <a class="card-link tx-white-7 hover-white" href="javascript:void(0);">Another link</a>
                </div>
            </div>
        </div>
        <div class="col-md mg-md-t-0">
    ...
    <div class="row row-sm">
        <div class="col-md-4 col-lg-4">
            <div class="card">
                ...
                <img alt="Image" class="img-fluid card-img-bottom" src="{{asset('build/assets/img/photos/1.jpg')}}">
            </div>
        </div><!-- col-4 -->
        <div class="col-md-4 col-lg-4 mg-md-t-0">
            <div class="card">
                ...
                <img alt="Image" class="img-fluid card-img-bottom" src="{{asset('build/assets/img/photos/2.jpg')}}">
            </div>
        </div><!-- col-4 -->
        <div class="col-md-4 col-lg-4 mg-md-t-0">
            <div class="card">
                ...
                <img alt="Image" class="img-fluid card-img-bottom" src="{{asset('build/assets/img/photos/11.jpg')}}">
            </div>
        </div><!-- col-4 -->
    </div>
    <!-- ROW CLOSED -->
