        ...
        <div class="col-lg-4 col-xl-3">
            <div class="card">
                <div class="main-content-left main-content-left-mail card-body">
                    <a class="btn btn-primary btn-compose" id="btnCompose" href="javascript:void(0);"><i
                                class="fa fa-plus mx-2"></i> Create Folder</a>
                    <div class="main-mail-menu">
                        <nav class="nav main-nav-column">
                            <a class="nav-link thumb active " href="javascript:void(0);"><i class="fe fe-image"></i>
                                Images </a>
                            ...
                            <a class="nav-link thumb" href="javascript:void(0);"><i class="fe fe-smartphone"></i>
                                APKS</a>
                            ...
                            <a class="nav-link thumb" href="javascript:void(0);"><i class="fe fe-share"></i> Transfer
                                files </a>
                            ...
                            <a class="nav-link thumb" href="javascript:void(0);"><i class="fe fe-lock"></i> Private
                                FIles</a>
                            <a class="nav-link thumb" href="javascript:void(0);"><i class="fe fe-wind"></i> Deep
                                Clean</a>
