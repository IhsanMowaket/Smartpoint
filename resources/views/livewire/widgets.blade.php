                    ...
                    <div>
                        <div class="chips">
                            <div class="team">
                                <a href="javascript:void(0);" class="chip">
                                                    <span class="avatar cover-image"
                                                          data-bs-image-src="{{asset('build/assets/img/users/2.jpg')}}"></span>
                                    Victoria
                                </a>
                            ...
                            <div class="team">
                                <a href="javascript:void(0);" class="chip">
                                                    <span class="avatar cover-image"
                                                          data-bs-image-src="{{asset('build/assets/img/users/3.jpg')}}"></span>
                                    Nathan
                                </a>
                                <i class="fab fa-facebook text-primary" aria-hidden="true"></i>
                                <i class="fab fa-twitter text-primary" aria-hidden="true"></i>
                            ...
                            <div class="team">
                                <a href="javascript:void(0);" class="chip">
                                                    <span class="avatar cover-image"
                                                          data-bs-image-src="{{asset('build/assets/img/users/4.jpg')}}"></span>
                                    Alice
                                </a>
                                <i class="fab fa-facebook text-primary" aria-hidden="true"></i>
                                <i class="fab fa-twitter text-primary" aria-hidden="true"></i>
            ...
            <div class="card">
                ...
                <div class="card-body p-0">
                    <table class="table card-table country-table mb-0">
                        ...
                        <tr>
                            <td class="w-1"><img src="{{asset('build/assets/img/flag-imgs/spain_flag.jpg')}}"
                                                 alt="flags"
                                                 class="flag wd-30 ht-20 flag-us mt-1"></td>
                            <td>Spain
                                <div class="progress progress-sm mt-1">
                        ...
                        <tr>
                            <td class="w-1"><img src="{{asset('build/assets/img/flag-imgs/italy_flag.jpg')}}"
                                                 alt="flags"
                                                 class="flag wd-30 ht-20 flag-us mt-1"></td>
                            <td>Italy
                                <div class="progress progress-sm mt-1">
            ...
            <div class="card">
                ...
                <div class="card-body pd-y-7">
                    ...
                    <div class="wrapper d-flex justify-content-center image-group pb-3">
                        <img src="{{asset('build/assets/img/users/1.jpg')}}" alt="profile"
                             class="img-xs rounded-circle">
                        <img src="{{asset('build/assets/img/users/2.jpg')}}" alt="profile"
                             class="img-xs rounded-circle">
                        <img src="{{asset('build/assets/img/users/13.jpg')}}" alt="profile"
                             class="img-xs rounded-circle">
                        <img src="{{asset('build/assets/img/users/14.jpg')}}" alt="profile"
                             class="img-xs rounded-circle">
                        <img src="{{asset('build/assets/img/users/5.jpg')}}" alt="profile"
                             class="img-xs rounded-circle">
