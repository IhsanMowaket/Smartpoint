    ...
    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <label class="ckbox"><input type="checkbox"
                                                        class="mb-2"><span>Checkbox Unchecked</span></label>
                        </div>
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                            <label class="ckbox"><input checked type="checkbox"
                                                        class="mb-2"><span>Checkbox Checked</span></label>
                        </div>
                        <div class="col-lg-3 mg-y-20 mg-lg-y-0">
                            <label class="ckbox"><input disabled type="checkbox"
                                                        class="mb-2"><span>Checkbox Disabled</span></label>
                        </div>
                    </div>
                    <div class="row mg-lg-t-15">
                        <div class="col-lg-3">
                            <label class="rdiobox"><input name="rdio" type="radio" class="mb-2">
                                <span>Radio Unchecked</span></label>
                        </div>
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                    ...
                    <div class="row row-sm">
                        ...
                        <div class="col-lg-4">
                            <div class="input-group mb-3">
                                ...
                                <input aria-label="Amount (to the nearest dollar)" class="form-control rounded-0"
                                       type="text">
                    ...
                    <div class="row row-sm">
                        ...
                        <div class="col-lg-4 mg-t-20 mg-lg-t-0">
                            <div class="input-group">
                                ...
                                <button class="btn btn-primary br-ts-0 br-bs-0" type="button"><i
                    ...
                    <div class="row row-sm">
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                            <div class="input-group">
                                ...
                                <input class="form-control" id="datepicker-month" placeholder="(000) 000-0000"
                                       type="text">
                            </div><!-- input-group -->
                        </div>
                        <div class="col-lg-4 mg-t-20 mg-lg-t-0">
                            <div class="input-group">
                                ...
                                <input class="form-control" id="datepicker-year" placeholder="(000) 000-0000 ext 0000"
                                       type="text">
                            </div><!-- input-group -->
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control" id="datepickerNoOfMonths" placeholder="MM/DD/YYYY"
                                       type="text">
                            </div><!-- input-group -->
                        </div>
                    </div>
        ...
        <div class="col-md-12 col-xl-12 col-xs-12 col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p>Customize the native <code class="highlighter-rouge">&lt;select&gt;</code>s with custom CSS that
                        changes the element’s initial appearance.</p>
                    <div class="form-group">
                        <label class="form-label">Default Select</label>
                        <select name="country" class="form-control select2-no-search"
                    ...
                    <div class="form-group">
                        ...
                        <select name="country" class="form-control form-select select2"
                                data-bs-placeholder="Select Country" disabled>
                            <option value="br">Brazil</option>
                            <option value="cz">Czech Republic</option>
                            <option value="de">Germany</option>
                            <option value="pl" selected>Poland</option>
