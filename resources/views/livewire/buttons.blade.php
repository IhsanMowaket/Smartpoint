                    ...
                    <div class="text-wrap">
                        <div class="example">
                            <div class="row row-xs wd-xl-80p">
                                ...
                                <div class="col-sm-6 col-md-3 mg-t-10 mg-sm-t-0">
                                    <button
                                            class="btn btn-secondary btn-rounded btn-block">Secondary
                                    </button>
                                </div>
                                <div class="col-sm-6 col-md-3 mg-t-10 mg-md-t-0">
                    ...
                    <div class="text-wrap">
                        <div class="example">
                            <div class="row row-xs wd-xl-80p">
                                <div class="col-sm-6 col-md-3 mg-t-10 mg-sm-t-0">
                                    <button
                                            class="btn btn-outline-primary  btn-rounded btn-block">Primary
                                    </button>
                                </div>
                                <div class="col-sm-6 col-md-3 mg-t-10 mg-sm-t-0">
                                    <button
                                            class="btn btn-outline-secondary btn-rounded  btn-block">Secondary
                                    </button>
                                </div>
                                <div class="col-sm-6 col-md-3 mg-t-10 mg-md-t-0">
                                    <button
                                            class="btn btn-outline-success btn-rounded  btn-block">Success
                                    </button>
                                </div>
                                <div class="col-sm-6 col-md-3 mg-t-10 mg-md-t-0">
                                    <button
                                            class="btn btn-outline-warning btn-rounded  btn-block">Warning
                                    </button>
                                </div>
                                <div class="col-sm-6 col-md-3 mg-t-10">
                                    <button
                                            class="btn btn-outline-danger btn-rounded  btn-block">Danger
                                    </button>
                                </div>
                                <div class="col-sm-6 col-md-3 mg-t-10">
                                    <button
                                            class="btn btn-outline-info btn-rounded  btn-block">Info
                                    </button>
                                </div>
                                <div class="col-sm-6 col-md-3 mg-t-10">
                                    <button
                                            class="btn btn-outline-light btn-rounded  btn-block">Light
                                    </button>
                                </div>
                                <div class="col-sm-6 col-md-3 mg-t-10">
                                    <button
                                            class="btn btn-outline-dark btn-rounded  btn-block">Dark
                                    </button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="example">
                            <div class="row row-xs wd-xl-80p btn-list">
                                ...
                                <button type="button" class="btn btn-warning mx-2 button-icon mb-1"><i
                                            class="fe fe-heart me-2"></i>I like
                                </button>
                                ...
                                <button type="button" class="btn btn-info mx-2 button-icon mb-1"><i
                                            class="fe fe-message-circle me-2"></i>Comment
                                </button>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row row-sm">
                                <div class="col-lg-6 mg-t-20 mg-lg-t-0">
                                    <div aria-label="Basic example" class="btn-group" role="group">
                                        ...
                                        <button
                                                class="btn btn-secondary pd-sm-x-25 pd-x-15 " type="button">Center
                                        </button>
