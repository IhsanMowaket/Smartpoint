        ...
        <div class="col-lg-12 col-md-12">
            <div class="card mg-b-20">
                <div class="card-body">
                    ...
                    <p class="mg-b-20 text-muted card-sub-title">Below exapmle badges are border button rounded
                        badges...</p>
                    <div class="text-wrap">
                        <div class="example">
                            <button type="button" class="btn btn-outline-primary mt-1 mb-1 me-3">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card mg-b-20">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        <div class="example">
                            <button type="button" class="btn btn-primary mt-1 mb-1 me-3">Primary <span
                                        class="badge bg-light ms-1">22</span></button>
                            <button type="button" class="btn btn-success mt-1 mb-1 me-3">Success <span
                                        class="badge bg-light  ms-1">New</span></button>
                            <button type="button" class="btn btn-info mt-1 mb-1 me-3">Info <span
                                        class="badge bg-light  ms-1">5</span></button>
                            <button type="button" class="btn btn-warning mt-1 mb-1 me-3">Warning <span
                                        class="badge bg-light badge-pill  ms-1"><i class="fe fe-plus-circle tx-14"></i></span>
                            </button>
                            <button type="button" class="btn btn-danger mt-1 mb-1 me-3">Danger <span
                                        class="badge bg-light badge-pill  ms-1">Updated</span></button>
                        </div>
                    </div>
                </div>
            </div>
