    ...
    <div class="row related-products-ltr-l">
        <div class="col-xl-3 col-md-6">
            <div class="card item-card">
                <div class="card-body pb-0 h-100">
                    <div class="text-center">
                        <img src="{{asset('build/assets/img/ecommerce/01.jpg')}}" alt="img"
                             class="img-fluid w-100 rounded-7">
                    </div>
                ...
                <div class="text-center border-top py-3 px-2 ">
                    ...
                    <a href="{{url('product-cart')}}" class="btn btn-success"><i class="fa fa-shopping-cart"></i> Add to
                        cart</a>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-md-6">
            <div class="card item-card">
                <div class="card-body pb-0 h-100">
                    <div class="text-center">
                        <img src="{{asset('build/assets/img/ecommerce/04.jpg')}}" alt="img"
                             class="img-fluid w-100 rounded-7">
                    </div>
                    <div class="card-body relative product-des">
                        <div class="cardtitle">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card item-card">
                <div class="card-body pb-0 h-100">
                    <div class="text-center">
                        <img src="{{asset('build/assets/img/ecommerce/07.jpg')}}" alt="img"
                             class="img-fluid w-100 rounded-7">
                    </div>
                    <div class="card-body relative product-des">
                        <div class="cardtitle">
