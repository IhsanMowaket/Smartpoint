            ...
            <div class="card">
                <div class="card-body">
                    <div>
                        ...
                        <p class="text-muted card-sub-title">First import a latest version of jquery in your page. Then
                            the jquery.sumoselect.min.js and its css (sumoselect.css)</p>
                    </div>
                    <div class="mb-4">
            ...
            <div class="card">
                <div class="card-body">
                    <div>
                        ...
                        <p class="text-muted card-sub-title">A JavaScript plugin for entering and validating
                            international telephone numbers. It adds a flag dropdown to any input, detects the user's
                            country, displays a relevant placeholder and provides formatting/validation methods.</p>
                    </div>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-12 col-md-4 mg-t-10 mg-md-t-0">
                            <input type="file" class="dropify"
                                   data-default-file="{{asset('build/assets/img/photos/1.jpg')}}" data-height="200">
                        </div>
                        <div class="col-sm-12 col-md-4 mg-t-10 mg-md-t-0">
