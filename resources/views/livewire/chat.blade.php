                        ...
                        <div class="main-content-app">
                            <div class="main-content-left main-content-left-chat overflow-hidden">
                                <nav class="nav main-nav-line main-nav-line-chat">
                                    <a class="nav-link active" data-bs-toggle="tab" href="javascript:void(0);">Recent
                                        Chat</a>
                                    ...
                                    <div class="content-inner">
                                        ...
                                        <div class="media flex-row-reverse">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <div class="main-msg-wrapper p-0"><img alt=""
                                ...
                                <div class="text-center border-bottom chat-image p-4 pb-0 mb-4 rounded-5 mt-1">
                                    <div class="text-center">
                                        <a class="" href="{{url('profile')}}"><img alt="avatar"
                                                                                   ...
                                                                                   src="{{asset('build/assets/img/users/2.jpg')}}"></a>
                                        <div class="float-end">
                                ...
                                <div class="">
                                    <div class="px-4">
                                        ...
                                        <div class="d-flex">
                                            <div>
                                                <a class="nav-link border rounded-pill chat-profile me-2"
                                                   href="javascript:void(0);"><i class="fe fe-shield"></i></a>
                                            </div>
                                            <div class="ms-2">
                                        ...
                                        <div class="d-flex">
                                            <div>
                                                <a class="nav-link border rounded-pill chat-profile me-2"
                                                   href="javascript:void(0);"><i class="fe fe-mail"></i></a>
                                            </div>
                                            <div class="ms-2">
                                            ...
                                            <div class="card-body pb-0 ps-0">
                                                <div class="border-0 p-0 mb-4">
                                                    <div class="media mt-0">
                                                        <div class="ps-0 me-3"><i
                                                                    class="fa fa-folder-open shared-files text-muted"></i>
                                                        </div>
                                                        <div class="media-body">
                                                            <div class="d-flex align-items-center">
                                                                <div class="mt-0">
                                                                    <h5 class="mb-1 tx-13 font-weight-sembold text-dark">
                                                                        Ex Document</h5>
                                                                    <p class="mb-0 tx-13 text-muted">ppt<span
                                                                                class="tx-11 ms-2 d-inline-block">1.2 mb</span>
                                                                    </p>
                                                                </div>
                                                ...
                                                <div class="border-0 p-0 mb-4">
                                                    <div class="media mt-0">
                                                        <div class="ps-0 me-3"><i
                                                                    class="fa fa-image shared-files text-muted"></i>
                                                        </div>
                                                        <div class="media-body">
                                                            <div class="d-flex align-items-center">
                                                                <div class="mt-0">
                                                                    <h5 class="mb-1 tx-13 font-weight-sembold text-dark">
                                                                        Sam Photo</h5>
                                                                    <p class="mb-0 tx-13 text-muted">img<span
                                                                                class="tx-11 ms-2 d-inline-block">12 mb</span>
                                                                    </p>
                                                                </div>
                                                                <span class="ms-auto wd-45p fs-16 ">
																					<span id="spark2"
                                                ...
                                                <div class="border-0 p-0 mb-0">
                                                    <div class="media mt-0">
                                                        <div class="ps-0 me-3"><i
                                                                    class="fa fa-envelope shared-files text-muted"></i>
                                                        </div>
                                                        <div class="media-body">
                                                            <div class="d-flex align-items-center">
                                                                <div class="mt-0">
                                                                    <h5 class="mb-1 tx-13 font-weight-sembold text-dark">
                                                                        video</h5>
                                                                    <p class="mb-0 tx-13 text-muted">Video<span
                                                                                class="tx-11 ms-2 d-inline-block">16 mb</span>
                                                                    </p>
                                                                </div>
                                                                <span class="ms-auto wd-45p fs-16 ">
																					<span id="spark3"
