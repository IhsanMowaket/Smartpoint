                                    ...
                                    <div class="row">
                                        <div class="col-xl-6 col-md-12">
                                            <div class="demo-static-toast mb-2 mt-2">
                                                <div aria-atomic="true" aria-live="assertive" class="toast fade show"
                                                    ...
                                                    <div class="toast-header bg-primary text-white py-2"><i
                                                                class="fe fe-home me-2 mb-1"></i>
                                                        <h6 class="tx-14 mg-b-0 mg-r-auto">Notification</h6><small>11
                                                            mins ago</small>
                                                        <button aria-label="Close" class="ms-2 mb-1 close tx-normal"
                                                                data-bs-dismiss="toast" type="button">
                                        ...
                                        <div class="col-xl-6 col-md-12">
                                            <div class="demo-static-toast mt-2 mb-2">
                                                <div aria-atomic="true" aria-live="assertive" class="toast fade show"
                                                     role="alert" data-bs-autohide="false">
                                                    <div class="toast-header bg-secondary text-white py-2"><i
                                                                class="fe fe-compass me-2 mb-1"></i>
                                                        <h6 class="tx-14 mg-b-0 mg-r-auto">Notification</h6><small>11
                                                            mins ago</small>
                                                        <button aria-label="Close" class="ms-2 mb-1 close tx-normal"
                                                                data-bs-dismiss="toast" type="button">
                                        ...
                                        <div class="col-xl-6 col-md-12">
                                            <div class="demo-static-toast mt-2 mb-2">
                                                <div aria-atomic="true" aria-live="assertive" class="toast fade show"
                                                     role="alert" data-bs-autohide="false">
                                                    <div class="toast-header bg-success text-white py-2"><i
                                                                class="fe fe-check-circle me-2 mb-1"></i>
                                                        <h6 class="tx-14 mg-b-0 mg-r-auto">Notification</h6><small>11
                                                            mins ago</small>
                                                        <button aria-label="Close" class="ms-2 mb-1 close tx-normal"
                                                                data-bs-dismiss="toast" type="button">
                                        ...
                                        <div class="col-xl-6 col-md-12">
                                            <div class="demo-static-toast mt-2 mb-2">
                                                <div aria-atomic="true" aria-live="assertive" class="toast fade show"
                                                     role="alert" data-bs-autohide="false">
                                                    <div class="toast-header bg-info text-white py-2"><i
                                                                class="fe fe-info me-2 mb-1"></i>
                                                        <h6 class="tx-14 mg-b-0 mg-r-auto">Notification</h6><small>11
                                                            mins ago</small>
                                                        <button aria-label="Close" class="ms-2 mb-1 close tx-normal"
                                                                data-bs-dismiss="toast" type="button">
