								...
								<div class="collapse navbar-collapse" id="navbarSupportedContent-4">
									<ul class="nav nav-item  navbar-nav-right ms-auto">
											...
											<div class="dropdown-menu">
												...
												<div class="main-notification-list Notification-scroll">
													...
													<div class="d-flex p-3 border-bottom">
														...
														<div class="ms-3">
															<a href="{{url('mail')}}"><h5 class="notification-label mb-1">Updates Available</h5></a>
													...
													<div class="d-flex p-3 border-bottom">
														...
														<div class="ms-3">
															<a href="{{url('mail')}}"><h5 class="notification-label mb-1">New Order Received</h5></a>
													...
													<div class="d-flex p-3 border-bottom">
														...
														<div class="ms-3">
															<a href="{{url('mail')}}"><h5 class="notification-label mb-1">New review received</h5></a>
													...
													<div class="d-flex p-3 border-bottom">
														...
														<div class="ms-3">
															<a href="{{url('mail')}}"><h5 class="notification-label mb-1">22 verified registrations</h5></a>
													...
													<div class="d-flex p-3 border-bottom">
														...
														<div class="ms-3">
															<a href="{{url('mail')}}"><h5 class="notification-label mb-1">Project has been approved</h5></a>
										...
										<li class="dropdown main-profile-menu nav nav-item nav-link">
											<a class="profile-user d-flex" href="javascript:void(0);"><img alt="" src="{{\Illuminate\Support\Facades\Auth::user()->photo}}"></a>
											<div class="dropdown-menu">
												<div class="main-header-profile bg-primary p-3">
													<div class="d-flex wd-100p">
														<div class="main-img-user"><img alt="" src="{{\Illuminate\Support\Facades\Auth::user()->photo}}" class=""></div>
														<div class="ms-3 my-auto">
															<h6>{{\Illuminate\Support\Facades\Auth::user()->name}}</h6><span>{{\Illuminate\Support\Facades\Auth::user()->company}}</span>
														</div>
													</div>
												</div>
