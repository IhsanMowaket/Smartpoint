							...
							<div class="app-sidebar__user clearfix">
								<div class="dropdown user-pro-body">
									<div class="main-img-user avatar-xl">
										...
										<img alt="user-img" src="{{\Illuminate\Support\Facades\Auth::user()->photo}}" ><span class="avatar-status profile-status bg-green"></span>
                                        </a>
                                    </div>
									<div class="user-info">
										<h4 class="fw-semibold mt-3 mb-0">{{\Illuminate\Support\Facades\Auth::user()->name}}r</h4>
										<span class="mb-0 text-muted">{{\Illuminate\Support\Facades\Auth::user()->company}}</span>
									</div>
								</div>
							</div>
							...
							<ul class="side-menu">
								...
								<li class="slide">
									<a class="side-menu__item" href="{{url('index')}}">
                                        ...
                                        <span class="badge bg-success text-light bg-side-text">1</span></a>
								</li>
								<li class="side-item side-item-category">General</li>
                                <li class="slide">
                                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                                        <i class="mb-3 mt-0 mdi  mdi-account-multiple side-menu__icon"  viewBox="0 0 2 2" >
                                        </i><span class="side-menu__label">Employee Management</span><i class="angle fe fe-chevron-down"></i></a>
                                    <ul class="slide-menu">
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane tab-content-show active" id="side11">
                                                        <ul class="sidemenu-list">
                                                            <li class="side-menu__label1"><a href="javascript:void(0);">Employee Management</a></li>
                                                            <li><a class="slide-item" href="{{url('employee')}}">Employee Directory </a></li>
                                                            <li><a class="slide-item" href="{{url('#')}}">Time Tracking</a></li>
                                                            <li><a class="slide-item" href="{{url('#')}}">Vacation Requests</a></li>
                                                            <li><a class="slide-item" href="{{url('#')}}">Performance Reviews</a></li>
                                                            <li><a class="slide-item" href="{{url('#')}}">Reports</a></li>
                                                            <li><a class="slide-item" href="{{url('#')}}">Announcements</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <li class="slide">
                                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                                        <i class="mb-3 bi bi-bar-chart-steps side-menu__icon" viewBox="0 0 24 24">
                                        </i>
                                        <span class="side-menu__label">Order Management</span><i class="angle fe fe-chevron-down"></i></a>
                                    <ul class="slide-menu">
                                        <li class="panel sidetab-menu">
                                            <div class="tab-menu-heading p-0 pb-2 border-0">
                                                <div class="tabs-menu ">
                                            ...
                                            <div class="panel-body tabs-menu-body p-0 border-0">
                                                <div class="tab-content">
                                                    <div class="tab-pane tab-content-show active" id="side14">
                                                        <ul class="sidemenu-list">
                                                            <li class="side-menu__label1"><a href="javascript:void(0);">Order Management</a></li>
                                                            <li><a class="slide-item" href="{{url('#')}}">Create Order</a></li>
                                                            <li><a class="slide-item" href="{{url('#')}}">Validate Order</a></li>
                                                            <li><a class="slide-item" href="{{url('#')}}">Operation Management</a></li>
                                                            <li><a class="slide-item" href="{{url('#')}}">Tracking</a></li>
                                                            <li><a class="slide-item" href="{{url('#')}}">Order History</a></li>
                                                            <li><a class="slide-item" href="{{url('#')}}">Modify Order</a></li>
                                                            <li><a class="slide-item" href="{{url('#')}}">Alerts</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <li class="slide">
									<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                                        <i class="mb-2 mt-0 mdi mdi-arrange-send-to-back side-menu__icon"  >
                                        </i><span class="side-menu__label">Project Management</span><i class="angle fe fe-chevron-down"></i></a>
									<ul class="slide-menu">
										<li class="panel sidetab-menu">
											<div class="tab-menu-heading p-0 pb-2 border-0">
												<div class="tabs-menu ">
											...
											<div class="panel-body tabs-menu-body p-0 border-0">
												<div class="tab-content">
													<div class="tab-pane tab-content-show active" id="side11">
														<ul class="sidemenu-list">
															<li class="side-menu__label1"><a href="javascript:void(0);">Project Management</a></li>
															<li><a class="slide-item" href="{{url('#')}}">Projects list</a></li>
															<li><a class="slide-item" href="{{url('#')}}">Task Assignments</a></li>
															<li><a class="slide-item" href="{{url('#')}}">Milestones and deadlines</a></li>
															<li><a class="slide-item" href="{{url('#')}}">Time and budget tracking</a></li>
														</ul>
													</div>
												</div>
											</div>
								...
								<li class="slide">
									<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                                        <i class="mb-3 fe fe-trending-up side-menu__icon" viewBox="0 0 24 24">
                                            <path d="M0 0h24v24H0V0z" fill="none"/>
                                        ...
                                        <span class="side-menu__label">Financial Management</span><i class="angle fe fe-chevron-down"></i></a>
									<ul class="slide-menu">
										<li class="panel sidetab-menu">
											<div class="tab-menu-heading p-0 pb-2 border-0">
												<div class="tabs-menu ">
											...
											<div class="panel-body tabs-menu-body p-0 border-0">
												<div class="tab-content">
													<div class="tab-pane tab-content-show active" id="side14">
														<ul class="sidemenu-list">
															<li class="side-menu__label1"><a href="javascript:void(0);">Financial Management</a></li>
															<li><a class="slide-item" href="{{url('invoices')}}">Invoices</a></li>
															<li><a class="slide-item" href="{{url('billings')}}">Billing</a></li>
															<li><a class="slide-item" href="{{url('#')}}">Budget allocation</a></li>
															<li><a class="slide-item" href="{{url('#')}}">Financial reporting</a></li>
															<li><a class="slide-item" href="{{url('#')}}">Cost analysis</a></li>
														</ul>
													</div>
												</div>
											</div>
                                ...
                                <li class="slide">
                                    ...
                                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                                        ...
                                        <span class="material-symbols-outlined mb-3 side-menu__icon" viewBox="0 0 24 24">
                                            partner_exchange </span>
                                        <span class="side-menu__label">Partner Management</span><i class="angle fe fe-chevron-down"></i></a>
                                    <ul class="slide-menu">
                                        <li class="panel sidetab-menu">
                                            <div class="tab-menu-heading p-0 pb-2 border-0">
                                                <div class="tabs-menu ">
                                            ...
                                            <div class="panel-body tabs-menu-body p-0 border-0">
                                                <div class="tab-content">
                                                    <div class="tab-pane tab-content-show active" id="side14">
                                                        <ul class="sidemenu-list">
                                                            <li class="side-menu__label1"><a href="javascript:void(0);">Partner Management</a></li>
                                                            <li><a class="slide-item" href="{{url('#')}}">Partner List</a></li>
                                                            <li><a class="slide-item" href="{{url('#')}}">Partner History</a></li>
                                                            <li><a class="slide-item" href="{{url('#')}}">Operations</a></li>
                                                            <li><a class="slide-item" href="{{url('#')}}">Timeline</a></li>
                                                            <li><a class="slide-item" href="{{url('#')}}">Billings</a></li>
                                                            <li><a class="slide-item" href="{{url('#')}}">Performance Reports</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <li class="slide">
                                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                                        <i class="mb-3 mt-0 mdi si si-people side-menu__icon"  >
                                  </i><span class="side-menu__label">CRM</span><i class="angle fe fe-chevron-down"></i></a>
                                    <ul class="slide-menu">
                                        <li class="panel sidetab-menu">
                                            <div class="tab-menu-heading p-0 pb-2 border-0">
                                                <div class="tabs-menu ">
                                            ...
                                            <div class="panel-body tabs-menu-body p-0 border-0">
                                                <div class="tab-content">
                                                    <div class="tab-pane tab-content-show active" id="side11">
                                                        <ul class="sidemenu-list">
                                                            <li class="side-menu__label1"><a href="javascript:void(0);">Customer Relationship Management</a></li>
                                                            <li><a class="slide-item" href="{{url('clients')}}">Customer List</a></li>
                                                            <li><a class="slide-item" href="{{url('#')}}">Timeline</a></li>
                                                            <li><a class="slide-item" href="{{url('#')}}">Order pipeline</a></li>
                                                            <li><a class="slide-item" href="{{url('#')}}">Marketing campaigns</a></li>
                                                            <li><a class="slide-item" href="{{url('#')}}">ROI Tracking</a></li>
                                                            <li><a class="slide-item" href="{{url('#')}}">Customer Feedback</a></li>
                                                            <li><a class="slide-item" href="{{url('#')}}">Announcement</a></li>
                                                            <li><a class="slide-item" href="{{url('#')}}">Alert</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <li class="slide">
                                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                                        <i class="mb-3 fe fe-package side-menu__icon" viewBox="0 0 24 24">
                                        </i>
                                        <span class="side-menu__label">Inventory</span><i class="angle fe fe-chevron-down"></i></a>
                                    <ul class="slide-menu">
                                        <li class="panel sidetab-menu">
                                            <div class="tab-menu-heading p-0 pb-2 border-0">
                                                <div class="tabs-menu ">
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane tab-content-show active" id="side14">
                                                        <ul class="sidemenu-list">
                                                            ...
                                                            <li><a class="slide-item" href="{{url('#')}}">Stock levels</a></li>
                                                            <li><a class="slide-item" href="{{url('#')}}">Supplier database</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <li class="slide">
                                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                                        <i class="mb-3 zmdi zmdi-car side-menu__icon" viewBox="0 0 24 24">
                                        </i>
                                        <span class="side-menu__label">Route Management</span><i class="angle fe fe-chevron-down"></i></a>
                                    <ul class="slide-menu">
                                        <li class="panel sidetab-menu">
                                            <div class="tab-menu-heading p-0 pb-2 border-0">
                                                <div class="tabs-menu ">
                                            ...
                                            <div class="panel-body tabs-menu-body p-0 border-0">
                                                <div class="tab-content">
                                                    <div class="tab-pane tab-content-show active" id="side14">
                                                        <ul class="sidemenu-list">
                                                            <li class="side-menu__label1"><a href="javascript:void(0);">Route Management</a></li>
                                                            <li><a class="slide-item" href="{{url('#')}}">Route Planing</a></li>
                                                            <li><a class="slide-item" href="{{url('#')}}">Traffic and Weather Updates</a></li>
                                                            <li><a class="slide-item" href="{{url('#')}}">Reporting and Analytics</a></li>
                                                            <li><a class="slide-item" href="{{url('#')}}">Emergency Management</a></li>
                                                            <li><a class="slide-item" href="{{url('#')}}">Alerts</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                ...
                                <li class="slide">
                                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                                        <i  class="mb-3 bi bi-bar-chart-fill side-menu__icon" viewBox="0 0 24 24">
                                        </i>
                                        <span class="side-menu__label">Analytics and Reporting</span><i class="angle fe fe-chevron-down"></i></a>
                                    <ul class="slide-menu">
                                        <li class="panel sidetab-menu">
                                            <div class="tab-menu-heading p-0 pb-2 border-0">
                                                <div class="tabs-menu ">
                                            ...
                                            <div class="panel-body tabs-menu-body p-0 border-0">
                                                <div class="tab-content">
                                                    <div class="tab-pane tab-content-show active" id="side14">
                                                        <ul class="sidemenu-list">
                                                            <li class="side-menu__label1"><a href="javascript:void(0);">Analytics and Reporting</a></li>
                                                            <li><a class="slide-item" href="{{url('#')}}">Reports</a></li>
                                                            <li><a class="slide-item" href="{{url('#')}}">Researches</a></li>
                                                            <li><a class="slide-item" href="{{url('#')}}">Case Analysis</a></li>
                                                            <li><a class="slide-item" href="{{url('#')}}">Market Analysis</a></li>
                                                            <li><a class="slide-item" href="{{url('#')}}">Improvement Plans</a></li>
                                                            <li><a class="slide-item" href="{{url('#')}}">Suggestions</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <li class="slide">
                                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                                        <i class="mb-3 typcn typcn-cog-outline side-menu__icon" viewBox="0 0 24 24">
                                        </i>
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane tab-content-show active" id="side14">
                                                        <ul class="sidemenu-list">
                                                            ...
                                                            <li><a class="slide-item" href="{{url('#')}}">User accounts</a></li>
                                                            <li><a class="slide-item" href="{{url('#')}}">Company settings</a></li>
                                                            <li><a class="slide-item" href="{{url('#')}}">System settings</a></li>
                                                            <li><a class="slide-item" href="{{url('#')}}">Permissions</a></li>
                                ...
                                <li class="slide">
                                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                                        <i class="mb-3 fe fe-help-circle side-menu__icon" viewBox="0 0 24 24">
                                            <path d="M0 0h24v24H0V0z" fill="none"/>
                                            <path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3"/>
                                            <path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/>
                                        </i>
                                        <span class="side-menu__label">Support and Resources </span><i class="angle fe fe-chevron-down"></i></a>
                                    <ul class="slide-menu">
                                        <li class="panel sidetab-menu">
                                            <div class="tab-menu-heading p-0 pb-2 border-0">
                                                <div class="tabs-menu ">
                                            ...
                                            <div class="panel-body tabs-menu-body p-0 border-0">
                                                <div class="tab-content">
                                                    <div class="tab-pane tab-content-show active" id="side14">
                                                        <ul class="sidemenu-list">
                                                            <li class="side-menu__label1"><a href="javascript:void(0);">Support and Resources</a></li>
                                                            <li><a class="slide-item" href="{{url('#')}}">F&Q</a></li>
                                                            <li><a class="slide-item" href="{{url('#')}}">Resources</a></li>
                                                            <li><a class="slide-item" href="{{url('#')}}">Contact us</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <li class="slide">
                                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                                        <i class="mb-3 mt-0 mdi mdi-account-multiple side-menu__icon"  >
                                            <path d="M0 0h24v24H0V0z" fill="none"/>
