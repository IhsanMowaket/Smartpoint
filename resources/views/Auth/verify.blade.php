                                                    ...
                                                    <div class="main-signup-header">
                                                        ...
                                                        <form method="POST" action="{{ url('login/verify') }}">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input id="login_code" name="login_code" class="form-control @error('login_code') is-invalid @enderror" placeholder="*** ***" type="text" required>
                                                            </div>
                                                            <button type="submit" class="btn btn-main-primary btn-block">Verify Code</button>
                                                        </form>
