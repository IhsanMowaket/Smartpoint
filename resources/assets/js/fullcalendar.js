document.addEventListener('DOMContentLoaded', function() {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        editable: true,
        dayMaxEvents: true
        // Removed static events to replace with dynamic events from Laravel
    });

    calendar.render();

    // Function to fetch tasks from Laravel
    function fetchTasks() {
        var employeeId = {{ $employee-> }}; // Replace with the actual employee ID
